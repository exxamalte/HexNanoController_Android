...
public class IpcProxy {
  ...
  public void onRecordComplete(boolean isSuccess) {
    if (mOnRecordCompleteListeners == null
      ...
      return;
    for (OnRecordCompleteListener mOnRecordCompleteListener : mOnRecordCompleteListeners) {
      mOnRecordCompleteListener.onRecordComplete(isSuccess);
    }
  }
